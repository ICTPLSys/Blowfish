...
#define IF_HAVE_PG_BLOWFISH_SKIP_SPLIT(flag,string) ,{1UL << flag, string}
#else
#define IF_HAVE_PG_BLOWFISH_SKIP_SPLIT(flag,string)
#endif
...
IF_HAVE_PG_BLOWFISH_SKIP_SPLIT(PG_blowfish_skip_split, "blowfish_skip_split") \
IF_HAVE_PG_BLOWFISH_SKIP_SPLIT(PG_blowfish_host_reported, "blowfish_host_reported") \
