...
enum adc_time_stat_type {
	...
	ADC_POLL_ALL,
	ADC_SWAP_PRE_LAT,
	ADC_EN_DE_QUEUE_HOST_LAT,
	ADC_RECLAIM_PAGE_LAT,
	ADC_MY_SWAP_OUT_LAT,
	ADC_MY_TLB_FLUSH_LAT,
	ADC_MY_SWAP_IN_LAT,
	ADC_GUEST_LEAK_LAT,
	ADC_GUEST_FILL_LAT,
	ADC_RECLAIM_LAT,
	...
	ADC_ALLOC_PAGE_LAT,
	ADC_PREFETCH_LAT,
	ADC_BLOWFISH_RECLAIM_LAT,
	/* shrink_folio_list_inner / swap reclaim path breakdown */
	ADC_SHRINK_WAIT_WRITEBACK_LAT,
	ADC_SHRINK_ADD_TO_SWAP_LAT,
	/* Every pageout_profiling() (incl. batched_pageout inner loop) */
	ADC_SHRINK_PAGEOUT_LAT,
	ADC_SHRINK_REMOVE_MAP_LAT,
	ADC_SHRINK_FILEMAP_RELEASE_LAT,
	/* Whole batched_pageout(); includes inner PAGEOUT_LAT accumulation */
	ADC_SHRINK_BATCH_PAGEOUT_LAT,
	NUM_ADC_LAT_TYPE,
