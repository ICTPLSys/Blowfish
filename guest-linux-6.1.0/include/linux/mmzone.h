...
#endif
#if defined(CONFIG_LRU_GEN) && defined(CONFIG_TRANSPARENT_HUGEPAGE) && defined(CONFIG_BLOWFISH)
	/*
	 * Private cursor for BLOWFISH MGLRU-THP periodic scanner.
	 * Indexed by [type][zone], only used in mm/vmscan.c.
	 */
	unsigned long			blowfish_thp_cursor_pfn[ANON_AND_FILE][MAX_NR_ZONES];
	unsigned long			blowfish_thp_cursor_valid;
#endif
#ifdef CONFIG_MEMCG
