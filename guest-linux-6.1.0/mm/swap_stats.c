...
static const char *adc_time_stat_names[NUM_ADC_TIME_STAT_TYPE] = {
	...
	"Swap Preparation"	, "En De queue and host latency", "Reclaim a cold page all" ,
	"Swap Out Latency", "TLB Flush Latency", "Swap In Latency",
	"Guest Leak Latency", "Guest Fill Latency", "Reclaim Latency", 
	"Restore Latency", "Swap Out Latency", "Alloc Page Latency", "Prefetch Latency",
	"Blowfish Reclaim Latency",
	"Shrink wait writeback   ",
	"Shrink add_to_swap      ",
	"Shrink pageout(writepg) ",
	"Shrink __remove_mapping ",
	"Shrink filemap_release  ",
	"Shrink batched_pageout  ",
};
