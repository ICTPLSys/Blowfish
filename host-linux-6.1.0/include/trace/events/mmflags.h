...
#ifdef CONFIG_64BIT
#define IF_HAVE_PG_BLOWFISH_RECLAIMED(flag,string) ,{1UL << flag, string}
#else
#define IF_HAVE_PG_BLOWFISH_RECLAIMED(flag,string)
#endif
...
IF_HAVE_PG_BLOWFISH_RECLAIMED(PG_blowfish_reclaimed, "blowfish_reclaimed") \
