 ...
 * [Hermit]
 */
extern bool __folio_lock_or_retry_skip_mmlock(struct folio *folio,
					    struct mm_struct *mm,
					    unsigned int flags);
 ...
 */
static inline bool folio_lock_or_retry_optim(struct folio *folio,
					      struct mm_struct *mm,
					      unsigned int flags)
{
	return folio_trylock(folio) ||
	       __folio_lock_or_retry_skip_mmlock(folio, mm, flags);
}
