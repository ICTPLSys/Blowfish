...
enum adc_time_stat_type {
	...
	ADC_POLL_ALL,
	ADC_FILL_HOST_LAT,
	ADC_FILL_HPT_EPT_LAT,
	ADC_FILL_WRITE_PAGE_LAT,
	ADC_LEAK_ALL2_LAT,
	ADC_LEAK_READ_PAGE_LAT,
	ADC_LEAK_HELP_LAT,
	ADC_LEAK_GET_PAGE_LAT,
	ADC_LEAK_HELP_OTHERS_LAT,
	ADC_HYPERCALL_READ_LAT,
	ADC_HYPERCALL_WRITE_LAT,
	ADC_FRONT_READ_LAT,
	ADC_FRONT_WRITE_LAT,
	ADC_FILL_ALL_LAT,
	ADC_LEAK_ALL_LAT,
	...
	ADC_LEAK_HPT_LAT,
	ADC_FILL_TLB_LAT,
	ADC_POPULATE_WRITE_LAT,  /* POPULATE_WRITE latency */
	ADC_DONTNEED_LAT,        /* DONTNEED latency */
	ADC_UNMAP_IOPT_LAT, /* UNMAP IOPT latency */
	ADC_MAP_IOPT_LAT, /* MAP IOPT latency */
	NUM_ADC_LAT_TYPE,
