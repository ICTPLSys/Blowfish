...
/**
 * VFIO_IOMMU_LINK_WITH_KVM - _IOW(VFIO_TYPE, VFIO_BASE + 21, __u32)
 *
 * Build the connection between VFIO IOMMU and current KVM.
 * Prepared for DMA Remapping.
 */
 #define VFIO_IOMMU_LINK_WITH_KVM _IO(VFIO_TYPE, VFIO_BASE + 21)

 #define VFIO_IOMMU_UNLINK_WITH_KVM _IO(VFIO_TYPE, VFIO_BASE + 24)


 #define VFIO_IOMMU_MAP_DMA_PROFILING _IO(VFIO_TYPE, VFIO_BASE + 25)

 #define VFIO_IOMMU_UNMAP_DMA_PROFILING _IO(VFIO_TYPE, VFIO_BASE + 26)
